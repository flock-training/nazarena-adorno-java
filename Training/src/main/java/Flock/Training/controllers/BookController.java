...
public class BookController {
    ...
    public List<Book> findBooks(@RequestParam(required = false) String publisher, @RequestParam(required = false) String genre, @RequestParam(required = false) String year) {
